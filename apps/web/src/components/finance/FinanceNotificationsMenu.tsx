...
import { demoFinanceNotifications } from "@/lib/finance-demo-data";
import { cn } from "@/lib/utils";

type Notif = (typeof demoFinanceNotifications)[number];

export function FinanceNotificationsMenu() {
  const [items, setItems] = useState<Notif[]>(demoFinanceNotifications);
